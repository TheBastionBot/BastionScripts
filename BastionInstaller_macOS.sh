...
echo
(cd "$INS_DIR" && git clone -b stable -q --depth 1 https://github.com/TheBastionBot/Bastion.git) || (echo -e "${CYAN}[Bastion]: ${RED}[ERROR] Unable to download Bastion system files.${NC}" && exit 1)
